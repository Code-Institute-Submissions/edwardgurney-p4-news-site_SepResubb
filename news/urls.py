...
from .views import HomeView, ArticleDetailView, submit_comment, upvote, search, downvote, inappropriate_comment, delete_comment
...
urlpatterns = [
    ...
    path('comment_delete/<pk>', delete_comment, name='delete-comment'),
